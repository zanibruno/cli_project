...
type_4 = self.new
type_4.name = doc.search(".content.container p strong")[3].text
type_4.description = doc.search(".content.container p")[7].text

type_5 = self.new
type_5.name = doc.search(".content.container span strong")[3].text
type_5.description = doc.search(".content.container span")[5].text

type_6 = self.new
type_6.name = doc.search(".content.container p strong")[4].text
type_6.description = doc.search(".content.container p")[12].text

type_7 = self.new
type_7.name = doc.search(".content.container p strong")[5].text
type_7.description = doc.search(".content.container p")[14].text

type_8 = self.new
type_8.name = doc.search(".content.container p strong")[6].text
